...
- Prefer propose_brain_draft over create_personal_skill / create_personal_agent so the user can edit in the Brain pane.
- list_personal_skills / get_personal_skill / list_personal_agents / get_personal_agent / list_task_followups / list_recent_session_grades inspect the library and grades.
